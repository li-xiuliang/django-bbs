# -*- coding: utf-8 -*-
# Generated by Django 1.11.10 on 2020-11-17 08:19
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', models.FileField(default='avatar/default.png', upload_to='', verbose_name='头像')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=32, verbose_name='文章名')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('desc', models.CharField(max_length=255, verbose_name='站点标题')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=32, verbose_name='评论名')),
